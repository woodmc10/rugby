...
def process_video_data(video_path, annotations_path, output_dir, clip_length=40):
    ...
    # Analyze dataset
    analysis = analyze_dataset(clips_df)
    
    return clips_df, analysis


if __name__ == "__main__":
    # Test with your existing data
    video_path = 'data/rugby_7s/dataset_2025_01_23/video/usd_loyola.mp4'
    annotations_path = 'data/rugby_7s/dataset_2025_01_23/ann/usd_loyola.json'
    output_dir = 'data/rugby_7s/dataset_2025_01_23/processed/usd_loyola/'
